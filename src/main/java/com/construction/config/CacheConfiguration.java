...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.construction.domain.Batiment.class.getName());
            createCache(cm, com.construction.domain.Batiment.class.getName() + ".etages");
            createCache(cm, com.construction.domain.Appartement.class.getName());
            createCache(cm, com.construction.domain.Etage.class.getName());
            createCache(cm, com.construction.domain.Etage.class.getName() + ".appartements");
