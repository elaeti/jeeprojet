...
describe('Service Tests', () => {
  describe('Appartement Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(AppartementService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Appartement(0, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Appartement', () => {
        ...
        service.create(new Appartement()).subscribe(resp => (expectedResult = resp.body));
