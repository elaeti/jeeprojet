...
import { AppartementComponent } from 'app/entities/appartement/appartement.component';
...
describe('Component Tests', () => {
  describe('Appartement Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.appartements && comp.appartements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
