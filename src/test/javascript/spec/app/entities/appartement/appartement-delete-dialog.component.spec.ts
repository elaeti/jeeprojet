...
import { AppartementDeleteDialogComponent } from 'app/entities/appartement/appartement-delete-dialog.component';
  ...
  describe('Appartement Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [AppartementDeleteDialogComponent],
      })
