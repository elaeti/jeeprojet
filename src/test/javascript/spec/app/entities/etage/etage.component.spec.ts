...
import { EtageComponent } from 'app/entities/etage/etage.component';
import { EtageService } from 'app/entities/etage/etage.service';
import { Etage } from 'app/shared/model/etage.model';

describe('Component Tests', () => {
  describe('Etage Management Component', () => {
    let comp: EtageComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EtageComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.etages && comp.etages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
